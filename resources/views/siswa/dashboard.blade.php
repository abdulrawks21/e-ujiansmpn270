                    ...
                    <div class="widget widget-table-one p-3">
                        ...
                        <div class="widget-content">
                            @if ($notif_ujian->count() > 0)
                                ...
                                @if ($nu->ujian->jenis == 0)
                                    <a href="{{ url('siswa/ujian/' . $nu->kode) }}" class="@if($nu->waktu_berakhir == null) btn-kerjakan @endif" data-waktu_ujian="{{ $nu->ujian->waktu_ujian }}">
                                        <div class="transactions-list mt-1">
                                            <div class="t-item">
                                                <div class="t-company-name">
                                                    <div class="t-icon">
                                ...
                                @else
                                    <a href="{{ url('siswa/ujian_essay/' . $nu->kode) }}" class="@if($nu->waktu_berakhir == null) btn-kerjakan @endif" data-waktu_ujian="{{ $nu->ujian->waktu_ujian }}">
                                        <div class="transactions-list mt-1">
                                            <div class="t-item">
                                                <div class="t-company-name">
                                                    <div class="t-icon">
