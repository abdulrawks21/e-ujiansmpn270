                                        ...
                                        <tbody>
                                            @foreach ($ujian->sortBy('id') as $u)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($u->ujian->jenis == 0)
                                                            <a href="{{ url('siswa/ujian/' . $u->kode) }}" class="btn btn-primary btn-sm @if($u->waktu_berakhir === null) btn-kerjakan @endif" data-waktu_ujian="{{ $u->ujian->waktu_ujian }}">
                                                        ...
                                                        @else
                                                            <a href="{{ url('siswa/ujian_essay/' . $u->kode) }}" class="btn btn-primary btn-sm @if($u->waktu_berakhir === null) btn-kerjakan @endif" data-waktu_ujian="{{ $u->ujian->waktu_ujian }}">
