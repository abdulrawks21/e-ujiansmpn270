                        ...
                        <div class="widget shadow p-3">
                            <div class="widget-heading">
                                ...
                                <div class="row mt-3">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="">Waktu Ujian Dimulai</label>
                                            <div class="input-group">
                                                <input type="date" name="waktu_ujian_tgl" class="form-control" required>
                                                <input type="time" name="waktu_ujian_jam" class="form-control" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="">Waktu Ujian Dimulai</label>
                                    <div class="input-group">
                                        <input type="date" name="e_waktu_ujian_tgl" class="form-control" required>
                                        <input type="time" name="e_waktu_ujian_jam" class="form-control" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="">Waktu Ujian Dimulai</label>
                                    <div class="input-group">
                                        <input type="date" name="b_waktu_ujian_tgl" class="form-control" required>
                                        <input type="time" name="b_waktu_ujian_jam" class="form-control" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="table-responsive mt-3" style="overflow-x: scroll;">
                                    <table id="datatable-table" class="table text-center text-nowrap">
                                        ...
                                        <tbody>
                                            ...
                                            @if ($cek_bank == 0)
                                                <tr>
                                                    <td colspan="3">Belum Ada Bank Soal! Silahkan buat Terlebih Dahulu di menu Bank Soal</td>
                                                </tr>
                                            @endif
                                        </tbody>
                                    </table>
