...
<body>
    <div style="padding: 10px;">
        ...
        {{-- <small style="color: #000;">cbtmalela laravel-10 | by Abduloh</small> --}}
        <p style="font-family: `Segoe UI`, Tahoma, Geneva, Verdana, sans-serif; color: #000;">
            Halo {{ $details['nama'] }}, kamu telah mendaftar kedalam aplikasi SMPN 270. berikut merupakan informasi akunmu :
        </p>
