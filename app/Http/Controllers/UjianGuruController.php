...
class UjianGuruController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $ujian = [
            ...
            'menit' => $request->menit,
            'acak' => $request->acak,
            'waktu_ujian' => $request->waktu_ujian_tgl . ' ' . $request->waktu_ujian_jam
        ];
    ...
    public function pg_excel(Request $request)
    {
        ...
        $ujian = [
            ...
            'acak' => $request->e_acak,
            'waktu_ujian' => $request->e_waktu_ujian_tgl . ' ' . $request->e_waktu_ujian_jam
        ];
    ...
    public function store_bank_pg(Request $request)
    {
        ...
        $ujian = [
            ...
            'acak' => $request->b_acak,
            'waktu_ujian' => $request->b_waktu_ujian_tgl . ' ' . $request->b_waktu_ujian_jam
        ];
